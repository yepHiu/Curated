...
- A wishlist with named source-page links, background metadata enrichment, persistent posters, library matching and browser-plugin intake controlled by a switch in Settings → Network, with no token required; see [wishlist setup](docs/guide.md#wishlist).
