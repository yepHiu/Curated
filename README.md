...
- A docked Agent panel with automatic context compaction, persistent conversation summaries and record-backed movie answers; AI settings offer optional tool-call limits (unlimited by default), explicit write confirmation, measured token usage, timing and audit records; see the [handbook](docs/guide.md#ai-settings-and-governance).
