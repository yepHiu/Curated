...
- `GET /api/wishlist/items/{id}/playback`: on-demand fixed-site availability check (Jable and MISSAV), returning available/missing/unknown and a validated external link for confirmed matches; protected application session.
