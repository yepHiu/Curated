...
POST   /api/homepage/recommendations/refresh # Force-regenerate the current UTC-day homepage recommendation snapshot; optional body preserveHeroMovieIds keeps the hero slate
