...
| 平台 | 安装包 | 便携 / 离线包 |
|---|---|---|
| Windows x64 Full | `Curated-Full-Setup-1.7.0-windows-x64.exe` | `Curated-Full-1.7.0-windows-x64.zip` |
...
详细迁移与兼容性边界见 [使用手册](https://github.com/yepHiu/Curated/blob/full-v1.7.0/docs/guide.md)。
