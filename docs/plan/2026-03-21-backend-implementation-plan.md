...
- `docs/product/2026-03-20-jav-libary.md` 描述的是目标产品蓝图，不代表这些后端能力已经存在。
...
`docs/product/2026-03-20-jav-libary.md` 中已经定义了 `movies`、`actors`、`movie_actors`、`tags`、`movie_tags`。这些结构可作为 MVP 起点，但不足以支撑完整后台任务和资源管理。
...
- `docs/reference/2026-03-21-backend-contract-constraints.md`：约束命令、事件、DTO、错误码和对外协议边界
- `docs/reference/2026-03-21-backend-go-standards.md`：约束 `Go` 目录结构、分层方式、错误处理、日志和测试习惯
- `docs/reference/2026-03-21-backend-task-constraints.md`：约束扫描、搜刮、资源缓存等后台任务的统一模型

后续若项目真正进入实现阶段，应优先更新本文和 `docs/reference/2026-03-20-project-memory.md`，确保“当前事实”和“未来目标”保持清晰分离。
