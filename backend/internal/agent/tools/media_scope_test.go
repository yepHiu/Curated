...
func TestAgentTaskLookupDoesNotExposeBookTasks(t *testing.T) {
	for _, kind := range []string{contracts.TaskTypeScanComics, contracts.TaskTypeScanPhotos, contracts.TaskTypeImportComics, contracts.TaskTypeComicCacheCleanup, "photo.cache.cleanup", "future.domain"} {
