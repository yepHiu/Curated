...
func (h *Handler) Routes() http.Handler {
	...
	mux.HandleFunc("GET /api/library/comics/books/{comicId}/comment", h.handleGetComicComment)
	mux.HandleFunc("PUT /api/library/comics/books/{comicId}/comment", h.handlePutComicComment)
