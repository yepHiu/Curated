...
var (
	ErrUnsupportedArchive = errors.New("unsupported photo archive")
	ErrArchiveEmpty       = errors.New("photo archive contains no supported image pages")
	ErrPageNotFound       = errors.New("photo page not found")
)
