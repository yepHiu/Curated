...
/** 设置页内常规按钮、选择器触发器、侧栏 Tab 统一高度 32px（h-8）；
 * 需要移动端舒适触控的主动作可用 data-settings-comfortable-control 显式退出该密度约束。
 * DialogTrigger as-child 根节点为 dialog-trigger，需一并约束。
 */
const SETTINGS_CONTROL_H32_CLASS =
  "[&_[data-slot=button]:not([data-settings-comfortable-control])]:!h-8 [&_[data-slot=button]:not([data-settings-comfortable-control])]:!min-h-8 [&_[data-slot=button]:not([data-settings-comfortable-control])]:!max-h-8 [&_[data-slot=button][data-size=icon]]:!size-8 [&_[data-slot=button][data-size=icon-sm]]:!size-8 [&_[data-slot=button][data-size=icon-lg]]:!size-8 [&_[data-slot=dialog-trigger]]:!h-8 [&_[data-slot=dialog-trigger]]:!min-h-8 [&_[data-slot=dialog-trigger]]:!max-h-8 [&_[data-slot=dialog-trigger][data-size=icon]]:!size-8 [&_[data-slot=dialog-trigger][data-size=icon-sm]]:!size-8 [&_[data-slot=dialog-trigger][data-size=icon-lg]]:!size-8 [&_[data-slot=select-trigger]]:!h-8 [&_[data-slot=select-trigger]]:!min-h-8 [&_[data-slot=select-trigger]]:!max-h-8 [&_[data-slot=select-trigger]]:!py-0 [&_[data-slot=tabs-trigger]]:!h-8 [&_[data-slot=tabs-trigger]]:!min-h-8 [&_[data-slot=tabs-trigger]]:!max-h-8 [&_[data-slot=tabs-trigger]]:!py-0"
