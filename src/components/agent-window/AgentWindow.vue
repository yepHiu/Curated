...
<template>
  ...
  >
    ...
    <div
      ...
      class="absolute inset-y-0 left-0 z-50 w-1.5 cursor-col-resize touch-none after:absolute after:inset-y-0 after:left-0 after:w-0.5 hover:after:bg-muted-foreground/20 focus-visible:outline-none focus-visible:after:bg-muted-foreground/40"
