          ...
          <CardContent class="px-5 pt-0">
            <form class="flex flex-col gap-4" :aria-busy="busy" @submit.prevent="connect()">
              ...
              <div class="flex flex-wrap items-center justify-end gap-2">
                <Button v-if="busy" type="button" variant="outline" class="h-[29px] rounded-full py-0" @click="cancel">{{ t('cancel') }}</Button>
                <Button type="submit" class="h-[29px] rounded-full px-5 py-0" :disabled="busy || !api || !address.trim()">
