...
| 高 | `docs/2026-04-08-agent-build-and-test.md` | **构建 / 编译 / 测试**：统一命令与工作目录（pnpm、Go），避免多 Agent 各套执行方式 |
...
**UI 设计规范（代码级）**：`docs/2026-03-24-frontend-ui-spec.md`。
...
修改架构或新增重要端点后，请同步更新 **`project-facts.mdc`**（必要时 **`workspace-quick-reference.mdc`**）、**`README.md`** 配置与 API 摘要、**`docs/2026-03-21-library-organize.md`**（若涉及 **`library-config.cfg`**）、**`CLAUDE.md`** API 列表，以及 **`docs/architecture-and-implementation.html`**（实现说明与功能对照表）。
